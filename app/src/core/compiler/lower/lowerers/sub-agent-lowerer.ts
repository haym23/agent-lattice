import type { LlmWriteExecNode } from '../../../ir/types';
...
export const subAgentLowerer: Lowerer = {
  ...
  lower(node) {
    ...
    const promptText = typeof node.config.prompt === 'string' ? node.config.prompt : '';
    ...
    return { nodes: [execNode], edges: [], requiredTemplates: ['llm-write-v1'] };
  },
};
