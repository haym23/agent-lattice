...
export class StateStore {
	...
	set(ref: string, value: unknown): void {
		...
		let current: Record<string, unknown> = this.state[namespace] as Record<
			string,
			unknown
		>;
