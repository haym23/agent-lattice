import type { ExecNode, InputProjection } from "@lattice/ir"
import type { LlmRequest } from "@lattice/llm"

// TODO: Fix architecture - packages should not depend on apps
// import type { PromptTemplateRegistry } from "../../apps/web/src/core/prompts/types";
type PromptTemplateRegistry = any // TODO: Move this type to a shared package
...
/**
 * Provides prompt compiler behavior.
 */
