...
import conditionalIcon from "./nodes/conditional.svg"
import recursionIcon from "./nodes/recursion.svg"
import nondeterministicIcon from "./nodes/nondeterministic.svg"
...
export const nodeTypeIconMap: Record<WorkflowNodeType, string> = {
  ...
  nondeterministic: nondeterministicIcon,
  prompt: promptIcon,
