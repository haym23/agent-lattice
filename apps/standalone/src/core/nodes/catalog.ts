...
export const nodeCatalog: NodeDefinition[] = [
  ...
  },
  {
    ...
    defaultConfig: { name: '', description: '', scope: 'project', outputPorts: 1 },
  },
  {
    type: 'mcp',
    ...
    defaultConfig: { mode: 'manualParameterConfig', serverId: '', toolName: '', outputPorts: 1 },
  },
  {
    type: 'flow',
    category: 'agent',
  ...
  },
  {
    ...
    description: 'Transform structured data with JSONPath, JMESPath, or JavaScript.',
  ...
  },
  {
    ...
    description: 'Receive incoming HTTP webhooks to trigger workflow execution.',
  ...
  },
  {
    ...
    description: 'Process lists in configurable batch sizes with rate limiting.',
