...
- Aligned standalone migration implementation in `apps/standalone` with the migration guide's node model direction by replacing legacy Phase 1 node taxonomy with documented workflow node types.
